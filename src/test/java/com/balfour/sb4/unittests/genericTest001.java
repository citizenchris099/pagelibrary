...
public class genericTest001 {
	...
	public void ocoTest003() throws InterruptedException {
		OCOPOJO oco = createOCOInfo("Comp", "2800", true);
	...
	public void ocoTest004() throws InterruptedException {
		...
		for (String st : projects) {
			...
			OCOPOJO oco1 = createOCOInfo("Check", "5000", "3000", false);
			OCOPOJO oco2 = createOCOInfo("Comp", "5000", "5000", true);
			OCOPOJO oco4 = oCOInfoClone(oco);
			OCOPOJO oco5 = oCOInfoClone(oco1);
			OCOPOJO oco6 = oCOInfoClone(oco2);
			new Sb4HomePage(driver).ChangeProject2(st);
			driver.get("https://sb3-qa.balfour.com/sales-orders/oncampus/");
			new Sb4OCOListPage(driver).createNewOrder().saveNewStartOCO(oco).saveNewStartOCO(oco1)
					.saveNewStartOCO(oco2);
			driver.get("https://sb3-qa.balfour.com/sales-orders/oncampus/");
