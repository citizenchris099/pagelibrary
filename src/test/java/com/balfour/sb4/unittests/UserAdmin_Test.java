...
public class UserAdmin_Test {
	...
	@Test
	public void userAdminTest005() throws InterruptedException,
		...
		new Sb4UserAdminPage(driver).editUser(ur0).goToProjNRole()
				.addProject("Y50063")
				.projAction("#f796094653f249bca764c2b040aa7ceb")
				.projRole("f796094653f249bca764c2b040aa7ceb", ur0.getRole())
				.LogOut().loginAs(ur0.getEmail(), ur0.getPword())
				.CheckProject("Y50063").LogOut()
				.loginAs(tp0.getMiscUname001(), tp0.getAdvPword());
		driver.get(tp0.getSbUAUrl());
		ur0.setProject("Y50063");
		new Sb4UserAdminPage(driver).editUser(ur0).goToProjNRole()
				.projAction("#Y50063").LogOut()
				.loginAs(ur0.getEmail(), ur0.getPword()).CheckProject("Y50061")
				.LogOut();
	}
	...
	private int createNewUserReg(UserRegPOJO obj, TestPOJO obj1)
			throws InterruptedException, InstantiationException,
			IllegalAccessException, ClassNotFoundException, SQLException {
